...
def test_file_methods():
    ...
    multi_line_file = open('src/files/test_multi_line_file.txt', 'r')
    ...
    assert multi_line_file.readline() == 'first line1\n'
    assert multi_line_file.readline() == 'second line2\n'
    assert multi_line_file.readline() == 'third line3\n'
