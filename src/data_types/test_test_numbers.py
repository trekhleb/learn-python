...
def test_test_integer_numbers():
    ...
    big_integer = 3565622255484
    long_variable = 48656324865123862512348530

    assert isinstance(positive_integer, int)
    assert isinstance(negative_integer, int)
    assert isinstance(big_integer, int)
    assert not isinstance(long_variable, int)


def test_test_booleans():
    """Boolean
...
def test_number_operators():
    ...
    # Float Division always returns a floating point number.
    # Interger division returns a integer number
    assert 12 / 3 == 4
    assert 12.0 / 5 == 2.4
    assert 12 / 5 == 2
    assert 17.0 / 3 == 5.666666666666667
